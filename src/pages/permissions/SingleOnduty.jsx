       ...
       <h1 className='font-bold'>From:</h1>
        ...
        <div>
          ...
          <div className='mb-2 flex flex-col'>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I'm, {data.fullName},a student of {data.classSection}, with Register Number {data.registerNumber},kindly request on-duty leave for <input type='number' placeholder=' enter number of days' className='border-b-2 w-auto text-center focus:outline-none focus:ring-0'/> on <>[ </><input type='date' className='border-b-2'/>  to  <input type='date' className='border-b-2 focus:outline-none focus:ring-0'/><> ]</> as I have to participate in <input type='text' placeholder=' enter event name' className='border-b-2 w-auto text-center focus:outline-none focus:ring-0'/> at <input type='text' placeholder=' enter venue name' className='border-b-2 flex-1 text-center focus:outline-none focus:ring-0'/>.
            </p>
          </div>
          <div className='mb-2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
