...
const SingleOnduty = () => {
  ...
  return (<div className='lg:flex lg:flex-col lg:justify-center lg:items-center mb-10'>
    <div ref={componentRef} className="w-full sm:w-[210mm] h-auto text-black mx-auto mt-6 bg-white p-5 sm:p-10 shadow-lg border border-red-950">
      ...
      <div className="flex flex-col sm:flex-row justify-between py-3 mt-6">
      ...
      <div className='p-1 flex flex-col gap-3'>
        <div className='flex justify-between'>
          ...
          <div>
            <img src="/raj.png" className="w-[100px] h-[120px] object-cover border mr-4 border-gray-300" />
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <h1 className='text-end flex gap-1 justify-end'><input type="checkbox"/><p>{data.fullName}</p></h1>
        </div>
        ...
        <div className="text-center border-2 p-3">
            On-Duty for the Above Mentioned Student
          </div>
      </div>
    </div>
